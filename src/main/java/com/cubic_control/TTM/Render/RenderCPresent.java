...
import com.cubic_control.TTM.Models.ModelPresent;
...
public class RenderCPresent extends TileEntitySpecialRenderer{
	
	ModelBase model;
	protected static ResourceLocation texture;
	
	public RenderCPresent(){
		model = new ModelPresent();
		texture = new ResourceLocation(RefStrings.MODID + ":textures/models/m_cPresent.png");
	}

...
public class RenderCTattletail_lol extends TileEntitySpecialRenderer{
	
	ModelBase model;
	protected static ResourceLocation texture;
	
	public RenderCTattletail_lol(){
		model = new ModelNewTattletail();
		texture = new ResourceLocation(RefStrings.MODID + ":textures/models/m_lol_T.png");
	}

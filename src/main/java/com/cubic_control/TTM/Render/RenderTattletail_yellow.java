...
public class RenderTattletail_yellow extends TileEntitySpecialRenderer{
	
	ModelBase model;
	protected static ResourceLocation texture;
	
	public RenderTattletail_yellow(){
		model = new ModelNewTattletail();
		texture = new ResourceLocation(RefStrings.MODID + ":textures/models/m_yellow_T.png");
	}

...
public class ModItemTattleTail_bendy extends ModItemBlockPlacer{

	public ModItemTattleTail_bendy(String name, float f1) {
		super(name, f1, MBlockManager.bendy_TattleTail);
	...
	public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
		if(world.isRemote){
			player.addChatComponentMessage(new ChatComponentText(EnumChatFormatting.BLACK+"<"+
					EnumChatFormatting.YELLOW+"Bendy Tail"+EnumChatFormatting.BLACK+">"+

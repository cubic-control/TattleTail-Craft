...
public class RenderTattletail_blue extends TileEntitySpecialRenderer{
	
	ModelBase model;
	protected static ResourceLocation texture;
	
	public RenderTattletail_blue(){
		model = new ModelTattletail();
		texture = new ResourceLocation(RefStrings.MODID + ":textures/models/m_blue_T.png");
	}

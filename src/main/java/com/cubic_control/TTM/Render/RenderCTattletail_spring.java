...
public class RenderCTattletail_spring extends TileEntitySpecialRenderer{
	
	ModelBase model;
	protected static ResourceLocation texture;
	
	public RenderCTattletail_spring(){
		model = new ModelNewTattletail();
		texture = new ResourceLocation(RefStrings.MODID + ":textures/models/m_spring_T.png");
		//texture = new ResourceLocation(RefStrings.MODID + ":textures/models/m_spring_T-1.png");
	}

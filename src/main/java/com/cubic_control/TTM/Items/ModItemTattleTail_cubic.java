...
public class ModItemTattleTail_cubic extends ModItemBlockPlacer{

	public ModItemTattleTail_cubic(String name, float f1) {
		super(name, f1, MBlockManager.cubic_TattleTail);
	...
	public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
		if(world.isRemote){
			player.addChatComponentMessage(new ChatComponentText(EnumChatFormatting.RED+"<"+
					EnumChatFormatting.BLUE+"Cubic Tail"+EnumChatFormatting.RED+">"+
					EnumChatFormatting.WHITE+"Thank you for downloading TattleTail Craft!"));
		}
		return stack;
	}
}
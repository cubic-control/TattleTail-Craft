...
public class RenderCTattletail_red extends TileEntitySpecialRenderer{
	
	ModelBase model;
	protected static ResourceLocation texture;
	
	public RenderCTattletail_red(){
		model = new ModelNewTattletail();
		texture = new ResourceLocation(RefStrings.MODID + ":textures/models/m_red_T.png");
	}

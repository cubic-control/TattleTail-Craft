...
public class RenderTattletail_purple extends TileEntitySpecialRenderer{
	
	ModelBase model;
	protected static ResourceLocation texture;
	
	public RenderTattletail_purple(){
		model = new ModelTattletail();
		texture = new ResourceLocation(RefStrings.MODID + ":textures/models/m_purple_T.png");
	}

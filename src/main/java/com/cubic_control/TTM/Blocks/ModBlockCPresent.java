...
public class ModBlockCPresent extends ModBlockContainer {

	protected ModBlockCPresent(String name) {
	...
	public Item getItemDropped(int i1, Random rand, int i2) {
        return MItemManager.cPresent;
    }
	@Override
	public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z) {
		return new ItemStack(MItemManager.cPresent);
	}

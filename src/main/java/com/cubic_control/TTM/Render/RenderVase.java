...
import com.cubic_control.TTM.Models.ModelVase;
...
public class RenderVase extends TileEntitySpecialRenderer{
	...
	public RenderVase(){
		model = new ModelVase();
		texture = new ResourceLocation(RefStrings.MODID + ":textures/models/m_vase.png");
	}

...
public class ModItemTattleTail_scott extends ModItemBlockPlacer{

	public ModItemTattleTail_scott(String name, float f1) {
		super(name, f1, MBlockManager.scott_TattleTail);
	...
	public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
		if(world.isRemote){
			player.addChatComponentMessage(new ChatComponentText(EnumChatFormatting.AQUA+"<"+
					EnumChatFormatting.DARK_AQUA+"Scott Tail"+EnumChatFormatting.AQUA+">"+

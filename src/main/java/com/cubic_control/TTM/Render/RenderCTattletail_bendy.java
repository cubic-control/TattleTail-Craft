...
public class RenderCTattletail_bendy extends TileEntitySpecialRenderer{
	
	ModelBase model;
	protected static ResourceLocation texture;
	
	public RenderCTattletail_bendy(){
		model = new ModelNewTattletail();
		texture = new ResourceLocation(RefStrings.MODID + ":textures/models/m_bendy_T.png");
	}

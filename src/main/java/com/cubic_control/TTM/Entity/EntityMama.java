...
public class EntityMama extends EntityMob{
	public int timeUntilNextEgg;

	public EntityMama(World par1World) {
		super(par1World);
	...
	public void onKillEntity(EntityLivingBase par1EntityLivingBase) {
		...
		if(par1EntityLivingBase instanceof EntityPlayer){
			System.out.println("["+RefStrings.NAME+"]"+":[TESTING]: This is an output log for testing EntityMama's Jumpscare.");
		}
	}
	@Override
	...
	protected String getLivingSound() {
		if(rand.nextInt(4) <= 0){
			return RefStrings.MODID + ":mama.cometomama";
		}else if(rand.nextInt() == 1){
			return RefStrings.MODID + ":mama.mamawilllookafteryou";
		}else if(rand.nextInt() == 2){
			return RefStrings.MODID + ":mama.mamaslookingafteryou";
		}else if(rand.nextInt() >= 3){
			return RefStrings.MODID + ":mama.mamascoming";
		}else{
			return null;
		}
    }

...
import com.cubic_control.TTM.Models.ModelCandles;
...
public class RenderCandles extends TileEntitySpecialRenderer{
	
	ModelBase model;
	protected static ResourceLocation texture;
	
	public RenderCandles(){
		model = new ModelCandles();
		texture = new ResourceLocation(RefStrings.MODID + ":textures/models/m_candles.png");
	}
